...
func TestGetRootRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			"+valid",
			[]byte{
				0xfe, 0x00, 0x0e, 0x00, 0x01, 0xc0, 0x01, 0x02, 0x32, 0x02, 0x60, 0x10, 0x6b, 0x0e, 0xa0, 0x0c,
				0x62, 0x0a, 0xa0, 0x03, 0x02, 0x01, 0x20, 0xa1, 0x03, 0x02, 0x01, 0xfd, 0xdf, 0x14, 0xcc, 0xff,
			},
			false,
		},
	}
...
func TestGetRequestByType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]byte{
				0xfe, 0x00, 0x0e, 0x00, 0x01, 0xc0, 0x01, 0x02, 0x32, 0x02, 0x60, 0x1d, 0x6b, 0x1b, 0xa0, 0x19,
				0x6a, 0x17, 0xa0, 0x03, 0x0d, 0x01, 0x01, 0xa2, 0x10, 0x64, 0x0e, 0xa0, 0x0c, 0x62, 0x0a, 0xa0,
				0x03, 0x02, 0x01, 0x20, 0xa1, 0x03, 0x02, 0x01, 0xfd, 0xdf, 0xb4, 0x7b, 0xff,
			},
			false,
		},
		{
