...
func TestEncode(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]byte{
				0xfe, 0x00, 0x0e, 0x00, 0x01, 0x60, 0x01, 0x02, 0x32, 0x02, 0x60, 0x80, 0x6b, 0x80, 0xa0, 0x80, 0x62,
				0x80, 0xa0, 0x03, 0x02, 0x01, 0x20, 0xa1, 0x03, 0x02, 0x01, 0xfd, 0xdf, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x9e, 0x58, 0xff,
			},
		},
		{
			"+multiPacket",
			...
			[]byte{
				0xfe, 0x00, 0x0e, 0x00, 0x01, 0x80, 0x01, 0x02, 0x32, 0x02, 0x60, 0x80, 0x6b, 0x80, 0xa0, 0x80, 0x62,
				0x80, 0xa0, 0x03, 0x02, 0x01, 0x20, 0xa1, 0x03, 0x02, 0x01, 0xfd, 0xdf, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0xc7, 0x65, 0xff, 0xfe, 0x00, 0x0e, 0x00, 0x01, 0x40, 0x01, 0x02, 0x32, 0x02, 0xe0,
				0x4b, 0xff,
			},
		},
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			[]byte{
				...
				0x32, 0x02, 0x60, 0x80, 0x6b, 0x80, 0xa0, 0x80,
				0x62, 0x80, 0xa0, 0x03, 0x02, 0x01, 0x20, 0xa1,
				0x03, 0x02, 0x01, 0xfd, 0xdf, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0xc7, 0x65, 0xff,
			},
		},
		{
			"+emptyPayload",
